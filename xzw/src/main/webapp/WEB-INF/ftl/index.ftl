...
<html lang="en"><head>
    ...
    <script type="text/html" id="bookTemplate">
        <!-- 一个图书 begin -->
        <a href="/xzw/book/{{bookId}}" style="color: inherit">
...
<div class="container">
    <nav class="navbar navbar-light bg-white shadow mr-auto">
        <ul class="nav">
            <li class="nav-item">
                <a href="index.html">
                    <img src="./resources/images/logo2.png" class="mt-1" style="width: 100px">
                </a>
            </li>
    ...
    <div class="row mt-2">
        ...
        <#-- data--xxx 是自定义属性，我们可以将要用的数据，定义到自定义属性中，方便我们获取 -->
        <div class="col-8 mt-2">
